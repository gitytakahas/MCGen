...
# with command line options: Configuration/GenProduction/python/BsToTauTauPHSP_To3PiNu_cfi.py --fileout file:TAU_GS_phsp.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --step GEN,SIM --geometry DB:Extended --era Run2_2018 --python_filename Tau_GS_cfg_phsp.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/BsToTauTauPHSP_To3PiNu_cfi.py nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/scratch/ytakahas/BsToTauTau_phsp.root'),
